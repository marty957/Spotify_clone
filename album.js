...
const savedColor = localStorage.getItem("lastBackgroundColor");
containerMain.style.background = `linear-gradient(0deg, rgba(0, 0, 0, 1) 19%, rgba(10, 10, 10, 1) 29%, rgba(10, 10, 10, 1) 33%, ${savedColor} 100%)`;
